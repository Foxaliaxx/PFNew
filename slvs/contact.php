...
<section id="social" class="reseaux_bloc"> 
        ...
        <div class="social_bloc">
            ...
            <p class="social_desc">Passioné de photographie, je poste certaines de mes creations ici. C'est aussi un moyen de me contacter grâce aux instagrams directs, les messages privés.</p>
        ...
        <div class="social_bloc">
            ...
            <img class="social_img" src="./asset/img/contact/social/svg/twitter.svg">
